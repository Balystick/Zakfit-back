...
final class Food: Model, Content, @unchecked Sendable {
    ...
    var fatsPerServing: Decimal

    @Field(key: "food_proteins_per_serving")
    var proteinsPerServing: Decimal
    ...
    init(id: UUID? = nil, name: String, servingSize: Decimal, caloriesPerServing: Decimal, fatsPerServing: Decimal, proteinsPerServing: Decimal, carbsPerServing: Decimal, isCustom: Bool, description: String?, categoryID: UUID, servingSizeUnitID: UUID) {
        self.id = id
        self.name = name
